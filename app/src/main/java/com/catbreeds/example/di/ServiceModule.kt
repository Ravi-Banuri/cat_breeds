...
import com.catbreeds.example.network.interceptor.HeaderInterceptor
import com.catbreeds.example.network.interceptor.NetworkConnectionInterceptor
...
object ServiceModule {
    ...
    @Provides
    @Singleton
    fun provideCatsService(retrofit: Retrofit): CatBreedService {
